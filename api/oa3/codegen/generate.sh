...
mkdir -p internal/codegen/server/chi
mkdir -p internal/codegen/server/echo

oapi-codegen -config api/oa3/codegen/server-chi.yaml api/oa3/api.yaml
oapi-codegen -config api/oa3/codegen/server-echo.yaml api/oa3/api.yaml
