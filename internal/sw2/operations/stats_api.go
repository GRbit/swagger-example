...
func NewStatsAPI(spec *loads.Document) *StatsAPI {
	return &StatsAPI{
		...
		AddAccUpdaterHandler: AddAccUpdaterHandlerFunc(func(params AddAccUpdaterParams, principal *model.Principal) middleware.Responder {
			return middleware.NotImplemented("operation AddAccUpdater has not yet been implemented")
		}),
		DelAccUpdaterHandler: DelAccUpdaterHandlerFunc(func(params DelAccUpdaterParams, principal *model.Principal) middleware.Responder {
			return middleware.NotImplemented("operation DelAccUpdater has not yet been implemented")
		}),
		GetAdsStatsHandler: GetAdsStatsHandlerFunc(func(params GetAdsStatsParams, principal *model.Principal) middleware.Responder {
			return middleware.NotImplemented("operation GetAdsStats has not yet been implemented")
		}),
		GetCampaignsStatsHandler: GetCampaignsStatsHandlerFunc(func(params GetCampaignsStatsParams, principal *model.Principal) middleware.Responder {
			return middleware.NotImplemented("operation GetCampaignsStats has not yet been implemented")
		}),

		// Applies when the "X-System-Token" header is set
		APIKeyAuthAuth: func(token string) (*model.Principal, error) {
...
func (o *StatsAPI) Validate() error {
	...
	if o.APIKeyAuthAuth == nil {
		unregistered = append(unregistered, "XSystemTokenAuth")
	}

	if o.AddAccUpdaterHandler == nil {
		unregistered = append(unregistered, "AddAccUpdaterHandler")
	}
	if o.DelAccUpdaterHandler == nil {
		unregistered = append(unregistered, "DelAccUpdaterHandler")
	}
	if o.GetAdsStatsHandler == nil {
		unregistered = append(unregistered, "GetAdsStatsHandler")
	}
	if o.GetCampaignsStatsHandler == nil {
		unregistered = append(unregistered, "GetCampaignsStatsHandler")
	}
...
func (o *StatsAPI) initHandlerCache() {
	...
	o.handlers["POST"][""] = NewAddAccUpdater(o.context, o.AddAccUpdaterHandler)
	if o.handlers["DELETE"] == nil {
		o.handlers["DELETE"] = make(map[string]http.Handler)
	}
	o.handlers["DELETE"]["/{account_id}"] = NewDelAccUpdater(o.context, o.DelAccUpdaterHandler)
	if o.handlers["GET"] == nil {
		o.handlers["GET"] = make(map[string]http.Handler)
	}
	o.handlers["GET"]["/{account_id}/ads"] = NewGetAdsStats(o.context, o.GetAdsStatsHandler)
	if o.handlers["GET"] == nil {
		o.handlers["GET"] = make(map[string]http.Handler)
	}
	o.handlers["GET"]["/{account_id}/campaigns"] = NewGetCampaignsStats(o.context, o.GetCampaignsStatsHandler)
}
